...
class parent():
    ...
    def doctor(doctor_name):
        hospital_list = ["Apex", "Apollo", "Tata Memorial Hospital", "Galaxy"]
    ...
    def softwareEngineer(it_professional_name):
        IT_company_list = ["I code", "Web Access", "Dotcom Services", "TCS"]
    ...
    def chemicalEngineer(chemical_engineer_name):
        ...
        company_list = ["Tata Chemicals LTD","Aarti Industries", "Pidilite Industries", "Nirma"]
